...
static const char vernum[] = "v60.rangi-1";       //
static const char devname[] = "garden-cam";         // name of your camera for mDNS, Router, and filenames
...
int  framesize = 10;                // vga  (10 UXGA, 7 SVGA, 6 VGA, 5 CIF)
int  repeat = 100;                 // 100 files
int  xspeed = 24;                   // 24 frames per second playback speed (@2 fph capture, playback at 24 fps means week will be compressed into 14 second video.)
int  gray = 0;                     // not gray
int  quality = 10;                 // 10 on the 0..64 scale, or 10..50 subscale - 10 is good, 20 is grainy and smaller files
long  capture_interval = 1800000;       // 1800000 ms or 2 frames per hour
int  total_frames = 336;         // 336 frames = 2 fph * 24 hours * 7 days = (1x week)
